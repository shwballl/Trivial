...
function Header({
  ...
  return (
    <header>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 border-b border-gray-600">
            ...
            {isAuthenticated ? (
              ...
              <>
                <button
                  ...
                  className="text-white hover:bg-gray-800 bg-gray-700 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 mr-2"
                >
                  Log in
                </button>
                <button
                  onClick={onRegisterClick}
                  className="text-white bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 mr-2"
                >
                  Get started
                </button>
              </>
          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <Link
                  to="/"
                  className="block py-2 pr-4 pl-3 rounded lg:bg-transparent lg:text-primary-700 lg:p-0 text-black"
                  aria-current="page"
                >
                  Find a Task
                </Link>
              ...
              <li>
                <Link
                  to="/create-task/"
                  className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:text-black lg:border-0 lg:p-0 lg:hover:text-primary-700"
                >
                  Create a Task
                </Link>
              </li>
